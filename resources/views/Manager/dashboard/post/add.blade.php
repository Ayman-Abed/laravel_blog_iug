    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form autocomplete="off" id="form_item" class="kt-form ajax_form" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote1" name="content" class="form-control" rows="5">{{ old('content') }}</textarea>
                                </div>
